...
public class lotteryConfig {
    ...
    public void loadConfigu() {
        customConfigFile = new File(XSCasino.getPlugin().getDataFolder(), "modules/lottery.yml");
        if (!customConfigFile.exists()) {
            customConfigFile.getParentFile().mkdirs();
            XSCasino.getPlugin().saveResource("modules/lottery.yml", false);
        }
    ...
    public static void reload() {
        config.customConfigFile = new File(XSCasino.getPlugin().getDataFolder(), "modules/lottery.yml");
