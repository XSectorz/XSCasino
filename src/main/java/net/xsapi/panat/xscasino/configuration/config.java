...
public class config {
    ...
    public void loadConfigu() {
        customConfigFile = new File(XSCasino.getPlugin().getDataFolder(), "config.yml");
        if (!customConfigFile.exists()) {
            customConfigFile.getParentFile().mkdirs();
            XSCasino.getPlugin().saveResource("config.yml", false);
        }
    ...
    public static void reload() {
        config.customConfigFile = new File(XSCasino.getPlugin().getDataFolder(), "config.yml");
